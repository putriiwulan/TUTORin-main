  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.header1}>Physics</Text>
      </View>

      <View style={styles.categoryList}>
        <KategoriKursus
          imageSource={require('./assets/intan.png')}
          name="Ms. Intan"
          rating="4.9"
          reviews="100"
          onPress={() => {
            console.log('Bio');
            setSelectedCourse('fisika');
            navigation.navigate('fisika');
          }}
          onViewMore={() => {
            console.log('View More Miss Aini');
            navigation.navigate('Profilmentor1'); // Ganti dengan nama rute yang sesuai
          }}
        />

        <KategoriKursus
          imageSource={require('./assets/putri.png')}
          name="Miss Putri"
